...
addOrbitsToScene();
  ...
  function onClick(event) {
    ...
    if (intersects.length > 0) {
      ...
      // giving the unnamed planet
      console.log('Planet clicked:', clickedPlanet.userData.name || 'Unnamed planet');
    }
  }
  // event listener for mouse clicks
window.addEventListener('click', onClick);
sun.onClick = function() {
  console.log("Planet clicked: " + this.name); // this one's not working idk why
};
