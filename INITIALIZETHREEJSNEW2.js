...
addOrbitsToScene();
  ...
  const sun = getSun();
  solarSystem.add(sun);
  sun.userData.name = 'Sun'; // Assign the name to the userData
  planets.push(sun);
  sun.userData.name = 'Sun'; // Ensure name is set
  ...
  mercury.userData.name = 'Mercury'; // Ensure name is set
  ...
  planets.push(venus);
  venus.userData.name = 'Venus'; // Ensure name is set
  ...
  planets.push(earth);
  earth.userData.name = 'Earth'; // Ensure name is set
  ...
  planets.push(mars);
  mars.userData.name = 'Mars'; // Ensure name is set
  ...
  jupiter.userData.name = 'Jupiter'; // Ensure name is set
  ...
  planets.push(saturn);
  saturn.userData.name = 'Saturn'; // Ensure name is set
  ...
  planets.push(uranus);
  uranus.userData.name = 'Uranus'; // Ensure name is set
  ...
  if (intersects.length > 0) {
    ...
    console.log("Clicked object: " + (clickedObject.userData.name || 'Unnamed object'));
    
    if (clickedObject === sun) {
      console.log("You clicked on the Sun!");
    } else if (clickedObject === mercury) {
      console.log("You clicked on Mercury!");
    }
  } else {
...
sun.onClick = function() {
  console.log("Planet clicked: " + this.name);  // still not working like this
};
